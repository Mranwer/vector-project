      ...
      <div className={cn(
        ...
        <div className="p-6">
          <Link href="/" className="flex items-center gap-2 group mb-8">
            ...
            <span className="font-bold text-lg tracking-tight">VTDS {isAdmin && <span className="text-primary text-xs ml-1 bg-primary/10 px-1 py-0.5 rounded">ADMIN</span>}</span>
          </Link>
