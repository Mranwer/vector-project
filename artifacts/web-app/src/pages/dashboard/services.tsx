...
import { Search, Zap, Clock, ShoppingCart, ZapIcon } from "lucide-react";

const CATEGORIES = ["All", "YouTube Services", "Web & App Development", "Meta Ads"];

const CATEGORY_ORDER = ["YouTube Services", "Web & App Development", "Meta Ads"];
    ...
    <p key={i} className="mb-1">{line}</p>
                      ...
                      <div className="flex items-center justify-between mb-3">
                        <span className="flex items-center gap-1 text-primary font-bold text-sm">
                          <ZapIcon/>
                          {service.pointsCost?.toLocaleString()}  Points
                        </span>
